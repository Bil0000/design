...
module.exports = {
  theme: {
    extend: {
      ...
      fontFamily: { display: "var(--font-display)", "display-serif": "var(--font-display-serif)", body: "var(--font-body)", "body-serif": "var(--font-body-serif)", sans: "var(--font-body)", serif: "var(--font-body-serif)", mono: "var(--font-mono)" },
      fontSize: {
        xs:    ["12px", { lineHeight: "1.6",  letterSpacing: "0.005em",  fontWeight: "400" }],
        sm:    ["14px", { lineHeight: "1.55", letterSpacing: "0",        fontWeight: "400" }],
        base:  ["17px", { lineHeight: "1.7",  letterSpacing: "-0.005em", fontWeight: "400" }],
        lg:    ["20px", { lineHeight: "1.5",  letterSpacing: "-0.015em", fontWeight: "500" }],
        xl:    ["24px", { lineHeight: "1.35", letterSpacing: "-0.02em",  fontWeight: "600" }],
        "2xl": ["32px", { lineHeight: "1.2",  letterSpacing: "-0.025em", fontWeight: "700" }],
        "3xl": ["44px", { lineHeight: "1.1",  letterSpacing: "-0.03em",  fontWeight: "700" }],
        "4xl": ["60px", { lineHeight: "1.0",  letterSpacing: "-0.04em",  fontWeight: "700" }],
      },
      spacing: { 0: "0", 1: "4px", 2: "8px", 3: "12px", 4: "16px", 6: "24px", 8: "32px", 12: "48px", 16: "64px", 24: "96px", 32: "128px" },
      borderRadius: { none: "0", sm: "4px", md: "6px", lg: "8px", xl: "12px", "2xl": "20px", full: "9999px" },
      ...
      transitionDuration: { instant: "0ms", fast: "100ms", normal: "150ms", slow: "250ms", deliberate: "400ms", spring: "350ms" },
