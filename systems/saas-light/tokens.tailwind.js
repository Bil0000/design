  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        lg:    ["18px", { lineHeight: "1.45", letterSpacing: "-0.01em",  fontWeight: "500" }],
        xl:    ["22px", { lineHeight: "1.3",  letterSpacing: "-0.02em",  fontWeight: "600" }],
        "2xl": ["30px", { lineHeight: "1.2",  letterSpacing: "-0.03em",  fontWeight: "600" }],
        "3xl": ["40px", { lineHeight: "1.1",  letterSpacing: "-0.04em",  fontWeight: "700" }],
        "4xl": ["56px", { lineHeight: "1.0",  letterSpacing: "-0.05em",  fontWeight: "700" }],
      },
