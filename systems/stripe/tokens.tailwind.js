  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        lg:    ["18px", { lineHeight: "1.5",  letterSpacing: "-0.01em",  fontWeight: "500" }],
        xl:    ["22px", { lineHeight: "1.35", letterSpacing: "-0.02em",  fontWeight: "600" }],
        "2xl": ["30px", { lineHeight: "1.2",  letterSpacing: "-0.03em",  fontWeight: "600" }],
        "3xl": ["42px", { lineHeight: "1.1",  letterSpacing: "-0.04em",  fontWeight: "700" }],
        "4xl": ["60px", { lineHeight: "1.0",  letterSpacing: "-0.05em",  fontWeight: "700" }],
        "5xl": ["84px", { lineHeight: "0.95", letterSpacing: "-0.055em", fontWeight: "700" }],
      },
